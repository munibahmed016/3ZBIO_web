    ...
    <div className="container mx-auto px-4 sm:px-24 py-8 text-gray-800">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className='mb-6 text-center text-gray-500 font-medium'>Once you place an order with us, you will receive a confirmation email containing your order details and a unique order number. This order number will be your key to tracking your order status. Here are the steps to check your order status:</p>
          <ul className="list-decimal pl-5 space-y-4 text-gray-500 font-medium">
            <li>
              <strong className='text-black text-2xl'>Order Confirmation Email</strong>
              <br /> Once you place an order with us, you'll receive an order
            ...
            <li>
              <strong className='text-black text-2xl'>Visit Our Website</strong>
              <br /> You can check the status of your order by simply visiting the order
              status page on our website. Enter your order number and email to see the latest updates on your order.
            </li>
            <li>
              <strong className='text-black text-2xl'>Track Your Shipment</strong> <br />Once your order is shipped, you'll receive a shipping confirmation
            ...
            <li>
              <strong className='text-black text-2xl'>Contact Customer Service</strong> <br />If you have any questions or need help with your order status,
